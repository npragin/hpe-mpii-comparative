    ...
    bbox_head=dict(
        ...
        transformer=dict(
            ...
            encoder=dict(
                ...
                num_layers=6, # From 6 to 8 for resnet 50. 6->5
            ...
            hm_encoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=dict(
                        ...
                        embed_dims=256,
                        num_levels=1),
                    feedforward_channels=1024, # 1024->512
                    ffn_dropout=0.1,
                    operation_order=('self_attn', 'norm', 'ffn', 'norm'))),
            refine_decoder=dict(
                type='mmcv.DeformableDetrTransformerDecoder',
                num_layers=2, # From 2 to 4
                return_intermediate=True,
                transformerlayers=dict(
                    type='mmcv.DetrTransformerDecoderLayer',
                    attn_cfgs=[
